...
Inventory.AddItem = function(src, item, count, slot, metadata)
    ...
    return sloth:AddItem(src, item, count, slot, metadata, 'fast-template')
end
...
Inventory.RemoveItem = function(src, item, count, slot, metadata)
    ...
    return sloth:RemoveItem(src, item, count, slot, 'fast-template')
end
...
Inventory.OpenStash = function(src, id, label, slots, weight, owner, groups, coords)
    TriggerClientEvent('fast-template:client:ps-inventory:openStash', src, id, { label = label, maxweight = weight, slots = slots, })
end
