...
Inventory.AddItem = function(src, item, count, slot, metadata)
    return exports['jpr-inventory']:AddItem(src, item, count, slot, metadata, 'fast-template Item added')
end
...
Inventory.RemoveItem = function(src, item, count, slot, metadata)
    return exports['jpr-inventory']:RemoveItem(src, item, count, slot, 'fast-template Item removed')
end
...
Inventory.OpenStash = function(src, id, label, slots, weight, owner, groups, coords)
    TriggerClientEvent('fast-template:client:jpr-inventory:openStash', src, id, { weight = weight, slots = slots })
end
...
---This will get the image path for an item, it is an alternate option to GetItemInfo. If a image isnt found will revert to fast-template logo (useful for menus)
---@param item string
---@return string
