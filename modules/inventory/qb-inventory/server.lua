...
Inventory.AddItem = function(src, item, count, slot, metadata)
    ...
    return exports['qb-inventory']:AddItem(src, item, count, slot, metadata, 'fast-template')
end
...
Inventory.RemoveItem = function(src, item, count, slot, metadata)
    ...
    return exports['qb-inventory']:RemoveItem(src, item, count, slot, 'fast-template')
end
...
Inventory.OpenStash = function(src, id, label, slots, weight, owner, groups, coords)
    TriggerClientEvent('fast-template:client:qb-inventory:openStash', src, id, { weight = weight, slots = slots })
end
