...
--- @return nil
RegisterNetEvent('fast-template:client:menuCallback', function(_args)
    local id = _args.id
...
local qbMenu = {
    ...
    },
    {
        ...
        params = {
            ...
            event = 'fast-template:client:TestEvent',
            args = {
                number = 1,
            }
        }
...
RegisterNetEvent('fast-template:client:TestEvent', function(args)
